...
| device_status | 设备态势 | DeviceStatusHandler | device_status_langgraph | /mcp/device | equip_class, category_health, month_maintenance, month_repair, statis_region, anfang_online, gb_online, mj_online, count |
